...
/* harmony export */ });
/* harmony import */ var _snippets_wasm_bindgen_rayon_7afa899f36665473_src_workerHelpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./snippets/wasm-bindgen-rayon-7afa899f36665473/src/workerHelpers.js */ "../prebuild/sak_proof_wasm/snippets/wasm-bindgen-rayon-7afa899f36665473/src/workerHelpers.js");
...
function initMemory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:412,maximum:16384,shared:true});
}
...
async function init(input, maybe_memory) {
    if (typeof input === 'undefined') {
        input = new URL(/* asset import */ __webpack_require__(/*! sak_proof_wasm_bg.wasm */ "../prebuild/sak_proof_wasm/sak_proof_wasm_bg.wasm"), __webpack_require__.b);
    }
    const imports = getImports();
...
/* harmony import */ var _prebuild_sak_proof_wasm_sak_proof_wasm_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../prebuild/sak_proof_wasm/sak_proof_wasm.js */ "../prebuild/sak_proof_wasm/sak_proof_wasm.js");



// Wrap wasm-bindgen exports (the `greet` function) to add time measurement.
function wrapExports({ greet }) {
    return async (int_arr) => {
        // let bb: number[] = [44, 55];
        ...
        return {
            ...
            proof: comlink__WEBPACK_IMPORTED_MODULE_1__.transfer(proof, [proof.buffer]),
            time,
        };
    };
}
async function initHandlers() {
    let [multiThread] = await Promise.all([
        (async () => {
            ...
            // );
            //
            const multiThread = await (0,_prebuild_sak_proof_wasm_sak_proof_wasm_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
/***/ "../prebuild/sak_proof_wasm/sak_proof_wasm_bg.wasm":
/*!*********************************************************!*\
  !*** ../prebuild/sak_proof_wasm/sak_proof_wasm_bg.wasm ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "04fed18f9738ca797f4c.wasm";
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-prebuild_sak_proof_wasm_snippets_wasm-bindgen-rayon-7afa899f36665473_src_workerHelper-6f635b"], () => (__webpack_require__("./web/wasm-worker.ts")))
...
/******/ 		};
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksak_proof_wasm"] = self["webpackChunksak_proof_wasm"] || [];
...
/******/ })()
;
//# sourceMappingURL=web_wasm-worker_ts.proof.js.map/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({
...
/******/ })()
;
//# sourceMappingURL=vendors-prebuild_sak_proof_wasm_snippets_wasm-bindgen-rayon-7afa899f36665473_src_workerHelper-6f635b.proof.js.map/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({
...
console.log(555);
let worker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("web_wasm-worker_ts"), __webpack_require__.b), {
    type: undefined,
});
const get_proof = async (p) => {
    let a = await comlink__WEBPACK_IMPORTED_MODULE_0__.wrap(worker).handlers;
